...
namespace XboxGamepassMVC.API_Pagos {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="API_PagosXboxSoap", Namespace="http://tempuri.org/")]
    public partial class API_PagosXbox : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback buscarPorCodigoOperationCompleted;
        
        private bool useDefaultCredentialsSetExplicitly;
        
        /// <remarks/>
        public API_PagosXbox() {
            this.Url = global::XboxGamepassMVC.Properties.Settings.Default.XboxGamepassMVC_API_Pagos_API_PagosXbox;
        ...
        /// <remarks/>
        public event buscarPorCodigoCompletedEventHandler buscarPorCodigoCompleted;
        ...
        /// <remarks/>
        public void InsertarAsync(Pago pago) {
            this.InsertarAsync(pago, null);
        }
        
        /// <remarks/>
        public void InsertarAsync(Pago pago, object userState) {
            ...
            this.InvokeAsync("Insertar", new object[] {
                        pago}, this.InsertarOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void ActualizarAsync(Pago pago) {
            this.ActualizarAsync(pago, null);
        }
        
        /// <remarks/>
        public void ActualizarAsync(Pago pago, object userState) {
            ...
            this.InvokeAsync("Actualizar", new object[] {
                        pago}, this.ActualizarOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/buscarPorCodigo", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public Pago buscarPorCodigo(string codigo) {
            object[] results = this.Invoke("buscarPorCodigo", new object[] {
                        codigo});
            return ((Pago)(results[0]));
        }
        
        /// <remarks/>
        public void buscarPorCodigoAsync(string codigo) {
            this.buscarPorCodigoAsync(codigo, null);
        }
        
        /// <remarks/>
        public void buscarPorCodigoAsync(string codigo, object userState) {
            if ((this.buscarPorCodigoOperationCompleted == null)) {
                this.buscarPorCodigoOperationCompleted = new System.Threading.SendOrPostCallback(this.OnbuscarPorCodigoOperationCompleted);
            }
            this.InvokeAsync("buscarPorCodigo", new object[] {
                        codigo}, this.buscarPorCodigoOperationCompleted, userState);
        }
        
        private void OnbuscarPorCodigoOperationCompleted(object arg) {
            if ((this.buscarPorCodigoCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.buscarPorCodigoCompleted(this, new buscarPorCodigoCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    public delegate void buscarPorCodigoCompletedEventHandler(object sender, buscarPorCodigoCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9032.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class buscarPorCodigoCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal buscarPorCodigoCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
